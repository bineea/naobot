...
真实 XIAO ESP32-S3 Sense 硬件仍未验收。2026-07-24 已在 HEAD `230eb75` 使用 MicroPython v1.28.0、ESP-IDF v5.5.1 和 esp32-camera v2.1.6 完成项目定制镜像的真实 C 编译：OTA 应用镜像 `micropython.bin` 为 1,838,096 字节，小于 `0x280000` app 分区，SHA-256 为 `6d8e44edd1a93e9e5b835a52f9fd62c7d994284d57dd53945599d6f3db1edb31`；首次烧录合并镜像 `firmware.bin` 为 1,969,168 字节。该证据仅证明构建、链接和分区尺寸通过，尚未证明真实烧录、签名 OTA、失败回滚、OV2640、I2S、PSRAM、USB CDC、OLED、MPU6050、触摸、舵机或 30 分钟稳定性。
