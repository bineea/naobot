...
真实 XIAO ESP32-S3 Sense 硬件仍未验收。2026-07-24 已在 HEAD `c1d84bb` 使用 MicroPython v1.28.0、ESP-IDF v5.5.1 和 esp32-camera v2.1.6 完成项目定制镜像的真实 C 编译：OTA 应用镜像 `micropython.bin` 为 1,838,560 字节，小于 `0x280000` app 分区，SHA-256 为 `5b010674879b3829572918d29dbbd9da16a34aa245addcfb62f172a57dd785d3`；首次烧录合并镜像 `firmware.bin` 为 1,969,632 字节，SHA-256 为 `d744ddf5ba1a1861ce9afa288cbcefb3c587bc89472ab48c5ddfbeda4d327a9b`。该证据仅证明构建、链接和分区尺寸通过，尚未证明真实烧录、签名 OTA、失败回滚、OV2640、PDM/I2S、PSRAM、USB CDC、OLED、MPU6050、触摸、舵机或 30 分钟稳定性。
