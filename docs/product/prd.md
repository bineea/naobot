...
真实 XIAO ESP32-S3 Sense 硬件仍未验收。2026-07-24 已在 HEAD `58b453b` 使用 MicroPython v1.28.0、ESP-IDF v5.5.1 和 esp32-camera v2.1.6 完成项目定制镜像的真实 C 编译：OTA 应用镜像 `micropython.bin` 为 1,839,888 字节，小于 `0x280000` app 分区，SHA-256 为 `06c3ac2c7cc00c2187b3ad309711a03a04931f7e9ce9889032dffc52a4e29a8e`；首次烧录合并镜像 `firmware.bin` 为 1,970,960 字节，SHA-256 为 `c98979d1a49eeaa459a710f4658aa42afc3e58cd88aef58a2ca6d5f34740b465`。该证据仅证明构建、链接和分区尺寸通过，尚未证明真实烧录、签名 OTA、失败回滚、OV2640、PDM/I2S、PSRAM、USB CDC、OLED、MPU6050、触摸、舵机或 30 分钟稳定性。
